...
# custom optim work
from open_r1.custom_sft_trainers import SFTTrainerWithDAdamW, SFTTrainerWithFisher
import torch
...
def main(script_args, training_args, model_args):
    ...
    # to use dadamw, .yaml needs to contain "custom_optim: dadamw" and "preconditioner_power: 0.5"
    ...
    # to use dadamw, .yaml needs to contain "custom_optim: fisher", "recompute_fisher_intervals: 0.25", "retain_dataset_id", "ewc_lambda"
        ...
        print("about to create a fisher trainer!")
